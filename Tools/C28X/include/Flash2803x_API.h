...
void FlashInit_API( void );
extern uint16_T API_Flash_Erase(uint16_T sector);
extern uint16_T API_Flash_Program(uint16_T *FlashAddr, uint16_T *BufAddr, uint32_T Length);
extern uint16_T API_Flash_Verify(uint16_T *FlashAddr, uint16_T *BufAddr, uint16_T Length);
/*---------------------------------------------------------------------------
