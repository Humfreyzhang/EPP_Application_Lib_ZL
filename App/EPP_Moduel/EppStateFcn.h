...
#ifndef RTW_HEADER_EppStateFcn_h_
#define RTW_HEADER_EppStateFcn_h_
...
extern void EppStateFcn_Init(void);
extern void EppStateFcn(void);

#endif                                 /* RTW_HEADER_EppStateFcn_h_ */
